...
function shutter(i, els) {
  ...
  class SingleNonProfitCard extends Component {
    state = {index:0}
      render() {
      ...
      <main>
        ...
        {this.props.nonprofit ? shutter(this.state.index, this.props.nonprofit).map(({imageLink, name, description}) => 
...
export default SingleNonProfitCard;
